<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="form-group {{ $errors->has('company_id') ? 'has-error' : ''}}">
            ...
            <input type="text" name="company_id" value="{{ isset($setting->company_id) ? $setting->company_id : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('api_key') ? 'has-error' : ''}}">
            <label for="api_key" class="control-label">{{ __('m.apiKey') }}</label>
            <input type="text" name="api_key" value="{{ isset($setting->api_key) ? $setting->api_key : ''}}" class="form-control"> {!! $errors->first('api_key', '
            <p class="help-block">:message</p>') !!}
        </div>
    ...
    <div class="tab-pane fade" id="theme" role="tabpanel" aria-labelledby="theme-tab">
        <div class="form-group {{ $errors->has('logo') ? 'has-error' : ''}}">
            ...
            <img style="max-width:200px" src="{{URL::to('/')}}/images/{{$setting->logo}}"> {!! $errors->first('logo', '
            <p class="help-block">:message</p>') !!}
        </div>
          <div class="form-group {{ $errors->has('sticky_logo') ? 'has-error' : ''}}">
            ...
            <img style="max-width:200px" src="{{URL::to('/')}}/images/{{$setting->sticky_logo}}"> {!! $errors->first('sticky_logo', '
            <p class="help-block">:message</p>') !!}
        </div>
    ...
    <div class="tab-pane fade" id="other" role="tabpanel" aria-labelledby="other-tab">
        <div class="form-group {{ $errors->has('site_name') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="site_name" type="text" id="site_name" value="{{ isset($setting->site_name) ? $setting->site_name : ''}}"> {!! $errors->first('site_name', '
            <p class="help-block">:message</p>') !!}
        </div>
        ...
        <div class="form-group {{ $errors->has('from_email') ? 'has-error' : ''}}">
            ...
            <input type="text" name="from_email" value="{{ isset($setting->from_email) ? $setting->from_email : ''}}" class="form-control"> {!! $errors->first('from_email', '
            <p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('pagination_length') ? 'has-error' : ''}}">
            ...
            <input type="number" name="pagination_length" value="{{ isset($setting->pagination_length) ? $setting->pagination_length : 5}}" class="form-control"> {!! $errors->first('pagination_length', '
            <p class="help-block">:message</p>') !!}
        </div>
        ...
        <div class="form-group {{ $errors->has('phone') ? 'has-error' : ''}}">
            ...
            <input type="text" class="form-control" name="phone" value="{{ isset($setting->phone) ? $setting->phone : ''}}"> {!! $errors->first('phone', '
            <p class="help-block">:message</p>') !!}
        </div>
    ...
    <div class="tab-pane fade " id="smtp" role="tabpanel" aria-labelledby="smtp-tab">
        <div class="form-group {{ $errors->has('host') ? 'has-error' : ''}}">
            ...
            <input type="text" name="host" value="{{ isset($setting->host) ? $setting->host : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('port') ? 'has-error' : ''}}">
            <label for="port" class="control-label">{{ __('m.port') }}</label>
            <input type="text" name="port" value="{{ isset($setting->port) ? $setting->port : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('from_name') ? 'has-error' : ''}}">
            <label for="from_name" class="control-label">{{ __('m.fromName') }}</label>
            <input type="text" name="from_name" value="{{ isset($setting->from_name) ? $setting->from_name : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('encryption') ? 'has-error' : ''}}">
            <label for="encryption" class="control-label">{{ __('m.encryption') }}</label>
            <input type="text" name="encryption" value="{{ isset($setting->encryption) ? $setting->encryption : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('username') ? 'has-error' : ''}}">
            <label for="username" class="control-label">{{ __('m.userName') }}</label>
            <input type="text" name="username" value="{{ isset($setting->username) ? $setting->username : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
    ...
    <div class="tab-pane fade " id="footer" role="tabpanel" aria-labelledby="footer-tab">
        ...
        <div class="form-group {{ $errors->has('contact_email') ? 'has-error' : ''}}">
            ...
            <input type="text" name="contact_email" value="{{ isset($setting->contact_email) ? $setting->contact_email : ''}}" class="form-control"> {!! $errors->first('company_id', '
            <p class="help-block">:message</p>') !!}
        </div>
