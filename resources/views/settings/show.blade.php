                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Site Name </th><td> {{ $setting->site_name }} </td></tr><tr><th> Logo </th><td> {{ $setting->logo }} </td></tr><tr><th> Api Key </th><td> {{ $setting->api_key }} </td></tr><tr><th> From Email </th><td> {{ $setting->from_email }} </td></tr>
                                </tbody>
                            </table>
                        </div>
