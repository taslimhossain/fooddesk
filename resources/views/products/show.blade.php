                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Product Name Dch </th><td> {{ $product->product_name_dch }} </td></tr><tr><th> Product Description Dch </th><td> {{ $product->product_description_dch }} </td></tr><tr><th> Fid </th><td> {{ $product->fid }} </td></tr><tr><th> Category Id </th><td> {{ $product->category_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
