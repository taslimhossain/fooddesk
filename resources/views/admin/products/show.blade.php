                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $product->title }} </td></tr><tr><th> Content </th><td> {{ $product->content }} </td></tr><tr><th> Image </th><td> {{ $product->image }} </td></tr><tr><th> Category </th><td> {{ $product->category }} </td></tr>
                                </tbody>
                            </table>
                        </div>
