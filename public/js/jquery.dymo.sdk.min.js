...
this.Sa,"\n","Overhead start: ",this.tb," ms\n","Overhead end: ",this.sb," ms\n","Overhead comment: ",this.rb," ms\n");return a.join("")};function Ac(a){a=Math.round(a);var b="";if(a<1E3)b=" ";if(a<100)b="  ";if(a<10)b="   ";return b+a}function Bc(a){a=Math.round(a);return String(100+a/1E3%60).substring(1,3)+"."+String(1E3+a%1E3).substring(1,4)}new wc;function Cc(){this.jb=ia()}new Cc;Cc.prototype.w=function(a){this.jb=a};Cc.prototype.reset=function(){this.w(ia())};Cc.prototype.o=aa("jb");var Dc;function N(a,b){this.type=a;this.currentTarget=this.target=b}z(N,Ma);N.prototype.n=function(){delete this.type;delete this.target;delete this.currentTarget};N.prototype.S=n;N.prototype.oa=l;!I||Rb("9");I&&Rb("8");function Ec(a,b){a&&this.ka(a,b)}z(Ec,N);p=Ec.prototype;p.target=m;p.relatedTarget=m;p.offsetX=0;p.offsetY=0;p.clientX=0;p.clientY=0;p.screenX=0;p.screenY=0;p.button=0;p.keyCode=0;p.charCode=0;p.ctrlKey=n;p.altKey=n;p.shiftKey=n;p.metaKey=n;p.Xb=n;p.Ya=m;
p.ka=function(a,b){var c=this.type=a.type;this.target=a.target||a.srcElement;this.currentTarget=b;var d=a.relatedTarget;if(d){if(Fb)try{d=d.nodeName&&d}catch(e){d=m}}else if(c=="mouseover")d=a.fromElement;else if(c=="mouseout")d=a.toElement;this.relatedTarget=d;this.offsetX=a.offsetX!==undefined?a.offsetX:a.layerX;this.offsetY=a.offsetY!==undefined?a.offsetY:a.layerY;this.clientX=a.clientX!==undefined?a.clientX:a.pageX;this.clientY=a.clientY!==undefined?a.clientY:a.pageY;this.screenX=a.screenX||0;
this.screenY=a.screenY||0;this.button=a.button;this.keyCode=a.keyCode||0;this.charCode=a.charCode||(c=="keypress"?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.Xb=Ib?a.metaKey:a.ctrlKey;this.state=a.state;this.Ya=a;delete this.oa;delete this.S};p.n=function(){Ec.V.n.call(this);this.relatedTarget=this.currentTarget=this.target=this.Ya=m};function Fc(){}var Gc=0;p=Fc.prototype;p.key=0;p.T=n;p.Ra=n;p.ka=function(a,b,c,d,e,f){if(x(a))this.fb=l;else if(a&&a.handleEvent&&x(a.handleEvent))this.fb=n;else i(Error("Invalid listener argument"));this.ca=a;this.ib=b;this.src=c;this.type=d;this.capture=!!e;this.Ea=f;this.Ra=n;this.key=++Gc;this.T=n};p.handleEvent=function(a){if(this.fb)return this.ca.call(this.Ea||this.src,a);return this.ca.handleEvent.call(this.ca,a)};var Hc;var Ic=(Hc="ScriptEngine"in q&&q.ScriptEngine()=="JScript")?q.ScriptEngineMajorVersion()+"."+q.ScriptEngineMinorVersion()+"."+q.ScriptEngineBuildVersion():"0";var Jc,Kc,Lc,Mc,Nc,Oc,Pc,Qc,Rc,Sc,Tc;
...
function $c(a,b,c,d){if(!d.ma)if(d.hb){for(var e=0,f=0;e<d.length;e++)if(d[e].T){var g=d[e].ib;g.src=m;Pc(g);Rc(d[e])}else{if(e!=f)d[f]=d[e];f++}d.length=f;d.hb=n;if(f==0){Mc(d);delete O[a][b][c];O[a][b].c--;if(O[a][b].c==0){Kc(O[a][b]);delete O[a][b];O[a].c--}if(O[a].c==0){Kc(O[a]);delete O[a]}}}}
...
function bd(a,b,c,d,e){var f=1;b=y(b);if(a[b]){a.s--;a=a[b];if(a.ma)a.ma++;else a.ma=1;try{for(var g=a.length,h=0;h<g;h++){var j=a[h];if(j&&!j.T)f&=cd(j,e)!==n}}finally{a.ma--;$c(c,d,b,a)}}return Boolean(f)}function cd(a,b){var c=a.handleEvent(b);a.Ra&&Zc(a.key);return c}
Oc(function(a,b){if(!Uc[a])return l;var c=Uc[a],d=c.type,e=O;if(!(d in e))return l;e=e[d];var f,g;if(Dc===undefined)Dc=I&&!q.addEventListener;if(Dc){f=b||ba("window.event");var h=l in e,j=n in e;if(h){if(f.keyCode<0||f.returnValue!=undefined)return l;a:{var k=n;if(f.keyCode==0)try{f.keyCode=-1;break a}catch(o){k=l}if(k||f.returnValue==undefined)f.returnValue=l}}k=Sc();k.ka(f,this);f=l;try{if(h){for(var r=Lc(),t=k.currentTarget;t;t=t.parentNode)r.push(t);g=e[l];g.s=g.c;for(var B=r.length-1;!k.S&&B>=
...
"Submitting form",void 0);try{this.za=n;f.submit();a.close();if(Fb)this.ab=fd(this.ob,250,this)}catch(j){c="Error when submitting form: "+Xa(j);this.e.log(oc,c,void 0);Yc(a.getElementById(d),"load",this.Ka,n,this);a.close();yd(this,2)}}};p.abort=function(a){if(this.z){this.e.info("Request aborted");ad(zd(this));this.Na=this.z=this.ja=n;this.aa=a||7;this.dispatchEvent("abort");Ad(this)}};
...
s("dymo.label.framework.TapeCutMode",Kd,void 0);Kd.AutoCut="AutoCut";Kd.ChainMarks="ChainMarks";var Ld={};s("dymo.label.framework.AddressBarcodePosition",Ld,void 0);Ld.AboveAddress="AboveAddress";Ld.BelowAddress="BelowAddress";Ld.Suppress="Suppress";var Q={};s("dymo.label.framework.PrintJobStatus",Q,void 0);Q.qa=0;Q.Unknown=Q.qa;Q.Cb=1;Q.Printing=Q.Cb;Q.wb=2;Q.Finished=Q.wb;Q.vb=3;Q.Error=Q.vb;Q.Ab=4;Q.PaperOut=Q.Ab;Q.xb=5;Q.InQueue=Q.xb;Q.pa=-1;Q.ProcessingError=Q.pa;Q.Bb=-2;Q.PrinterBusy=Q.Bb;
...
"PreText"),b);break;case "CounterObject":U(T(c,"PreText"),b)}return this};$.prototype.setObjectText=$.prototype.gc;$.prototype.toString=function(){return this.Q()};s("dymo.label.framework.VERSION","1.2.4",void 0);function ke(a,b,c){this.isBrowserSupported=a;this.isFrameworkInstalled=b;this.errorDetails=c}
function Vd(){var a={la:n,$:n,F:""},b=window.navigator.platform;if(b.indexOf("Win")!=-1)if(typeof ActiveXObject!="undefined"){a.la=l;try{if(typeof new ActiveXObject("DYMOLabelFrameworkIEPlugin.Plugin")!="object")a.F="Unable to create DYMO.Label.Framework ActiveX object. Check that DYMO.Label.Framework is installed";else a.$=l}catch(c){a.F="Unable to create DYMO.Label.Framework ActiveX object. Check that DYMO.Label.Framework is installed. Exception details: "+c}}else{a.la=l;if(Od("application/x-dymolabel"))a.$=
l;else a.F="DYMO Label Framework Plugin is not installed"}else if(b.indexOf("Mac")!=-1){a.la=l;if(Od("application/x-dymolabel")){b=Pd();if(b.GetAPIVersion()>="2.0")a.$=l;else a.F="DYMO Label Safari Plugin is installed but outdated. Install the latest version."}else if(Od("application/x-npapi-dymolabel")){b=Td();if(!b||!b.getPrinters)a.F='DYMO NSAPI plugin is loaded but no callable functions found. If running Safari, then run it in 64-bit mode (MacOS X >= 10.7) or set "Open using Rosetta" option';
else a.$=l}else a.F="DYMO Label Plugin is not installed."}else a.F="The operating system is not supported.";return new ke(a.la,a.$,a.F)}s("dymo.label.framework.checkEnvironment",Vd,void 0);var le={};function me(a,b,c){this.l=a;this.$b=b;this.ac=c}me.prototype.getPrinters=function(){var a=ne(this.ac),b=new E(this.l),c=this.$b;if(c=="")c=b.t;for(b=0;b<a.length;++b){var d=a[b],e=d.name;d.name=e+" @ "+c;d.l=this.l;d.location=c;d.ea=e;d.printerUri=d.l;d.location=d.location;d.localName=d.ea}return a};
